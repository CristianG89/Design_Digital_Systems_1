...
HD_PWD='D:/Mis documentos/Trabajos/Estudios/5 NTNU Trondheim/1 Semester/Design of Digital Systems 1/Assignments/A5 Datapath design/assignment_5/assignment_5.runs/synth_1'
cd "$HD_PWD"
