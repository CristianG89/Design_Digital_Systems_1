...
HD_PWD='D:/Mis documentos/Trabajos/Estudios/5 NTNU Trondheim/1 Semester/Design of Digital Systems 1/Assignments/A4 Common VHDL pitfalls and misconceptions/P_Assig4/P_Assig4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design1.tcl
